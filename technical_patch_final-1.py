...
# ============================================================
# ROBUST WEEKLY / MONTHLY AGGREGATION
# ============================================================
...
def get_daily_history(symbol, days=800):
    ...
    now = time.time()
    cache_key = "technical_v4_rsi:" + symbol
...
def build_technical_row(symbol, history, live_quote=None):
    ...
    weekly_rsi_count = len(weekly_closes)
    monthly_rsi_count = len(monthly_closes)
    ...
    return {
        ...
        "weekly_rsi_count": weekly_rsi_count,
        "monthly_rsi_count": monthly_rsi_count,
        "bb_upper": bb_upper,
        "bb_middle": bb_middle,
        "bb_lower": bb_lower,
